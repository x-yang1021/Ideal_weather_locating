...
WMO_CODES = {
    ...
    95: "雷暴 (Thunderstorm)",
    96: "雷暴冰雹 (Thunderstorm with Slight Hail)",
    99: "雷暴冰雹 (Thunderstorm with Heavy Hail)",
}
...
WEATHER_CATEGORIES = {
    ...
    "多云 (Cloudy)": [2, 3],
    "雾 (Fog)": [45, 48],
    "雨 (Rain)": [51, 53, 55, 56, 57, 61, 63, 65, 66, 67, 80, 81, 82],
    "雪 (Snow)": [71, 73, 75, 77, 85, 86],
    "雷暴 (Thunderstorm)": [95, 96, 99],
}
    ...
    try:
        ...
        for i in range(len(daily["time"])):
            ...
            results.append({
                ...
                "weather_code": code,
                "weather_text": WMO_CODES.get(code, f"Unknown ({code})"),
            })
        return results
